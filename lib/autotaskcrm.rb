...
class AutoTaskCrm
  def initialize(username = nil, password = nil)
    ...
    @client = Savon.client(wsdl: "https://webservices3.autotask.net/atservices/1.5/atws.wsdl", namespace: "http://schemas.xmlsoap.org/soap/envelope/", basic_auth: ["#{@username}", "#{@password}"])
