...
class AutoTaskCrm
  ...
  def send_xml(xml, query = true)
    if query == true
      resp = @client.call(:query, xml: "<?xml version='1.0' encoding='UTF-8'?><soap:Envelope xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' xmlns:xsd='http://www.w3.org/2001/XMLSchema' xmlns:soap='http://www.w3.org/2003/05/soap-envelope'><soap:Body><query xmlns='http://autotask.net/ATWS/v1_5/'>#{xml}</query></soap:Body></soap:Envelope>")
